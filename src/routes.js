...
// === John's endpoints from http_endpoints/config.js ===
const ENDPOINTS = [
...
function methodsFor(ep){return ep.http_method==="*" ? ["get","post","put","patch","delete","options"] : [ep.http_method.toLowerCase()]}
